...
def main():
    ...
    insertQuery = ("INSERT INTO film(film_name, film_releaseDate, film_runtime, film_director, studio_id, genre_id) "
                   "VALUES ('Gladiator', '2000', '155', 'Ridley Scott', (SELECT studio_id FROM studio WHERE "
                   "studio_name = 'Universal Pictures'),(SELECT genre_id FROM genre WHERE genre_name = 'Drama') );")
    connection.commit()
